...
for iter_num in range(10):
    url = f'/scratch2/jcahoon/argml_data/Gower_50kb/tarball/200kb_{iter_num}.tar'
...
#     print("f1 score: ", f1_score(y_pred=y_pred,y_true=y_test,  average="samples",  zero_division=0  ))
    ofile = open(f'pr_curve/Gower_{model_name}_50k_sw_{model_type}_{iter_num}_y_out.npy', "wb")
    pickle.dump(torch.sigmoid(y_out), ofile)
    ofile.close()

    ofile = open(f'pr_curve/Gower_{model_name}_50k_sw_{model_type}_{iter_num}_y_test.npy', "wb")
